...
class _MenuScreenState extends State<MenuScreen> with WidgetsBindingObserver {
  ...
  String _categoryForQuestionNumber(int number) {
    if (number >= 1 && number <= 4) return 'English';
    if (number >= 5 && number <= 8) return 'Mathematics';
    if (number >= 9 && number <= 12) return 'Logical Reasoning';
  ...
  Future<List<Question>> _buildRandomPregeneratedQuestions(
    ...
    final fallbackGemini = await geminiService
        .generateQuestions(prompt, programInterest)
    ...
    final results = await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) => QuestionScreen(
          ...
          hasUnlimitedAccess: hasAdFreeAccess || hasGraceAccess,
          recordResults: false,
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 18),
                const CircularProgressIndicator(
                valueColor:
                  AlwaysStoppedAnimation<Color>(PnleTheme.warning),
              ),
              const SizedBox(height: 14),
              Text(
    ...
    showDialog(
      ...
      builder: (dialogContext) {
        return GeneratingTestDialog(
          ...
          hasUnlimitedAccess: hasAdFreeAccess,
          isFocusMode: activeIsFocusMode,
          focusCategory: activeFocusCategory,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: PnleTheme.warning.withValues(alpha: 0.15),
                        borderRadius: BorderRadius.circular(8),
                        border: Border.all(
                          color: PnleTheme.warning.withValues(alpha: 0.4),
                          width: 1.5,
                        ),
                      ),
                      child: Row(
                        ...
                        children: [
                          Icon(
                            ...
                            color: PnleTheme.warning.withValues(alpha: 0.8),
                            size: 20,
                          ),
                          const SizedBox(width: 10),
                          Expanded(
                ...
                ...categories.map((category) {
                  ...
                  return Padding(
                    ...
                    child: Text(
                      ...
                      style: GoogleFonts.outfit(
                        color: met ? PnleTheme.success : PnleTheme.warning,
                        fontSize: 12,
                        fontWeight: FontWeight.w600,
                      ),
                    ),
              ...
              if (!_isOnline)
                Container(
                  ...
                  padding:
                      const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
                  decoration: BoxDecoration(
                    color: PnleTheme.danger.withValues(alpha: 0.2),
                    borderRadius: BorderRadius.circular(10),
                    border: Border.all(
                        color: PnleTheme.danger.withValues(alpha: 0.6)),
                  ),
                  child: Row(
                    children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _poolWarmupComplete
                        ? PnleTheme.success.withValues(alpha: 0.18)
                        : PnleTheme.warning.withValues(alpha: 0.18),
                    borderRadius: BorderRadius.circular(10),
                    border: Border.all(
                      color: _poolWarmupComplete
                          ? PnleTheme.success.withValues(alpha: 0.7)
                          : PnleTheme.warning.withValues(alpha: 0.7),
                    ),
                  ),
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
...
*/
            ...
            child: BackdropFilter(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: isFocusMode
                        ? PnleTheme.danger.withValues(alpha: 0.6)
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: isFocusMode
                          ? PnleTheme.danger.withValues(alpha: 0.3)
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: GoogleFonts.outfit(
                          color:
                              isFocusMode ? PnleTheme.danger : PnleTheme.accent,
                          fontWeight: FontWeight.bold,
                          fontSize: 22,
                        ),
                      ),
  ...
  Widget _coverageItem(String category, String topic,
    ...
    final accentColor = isFocusMode ? PnleTheme.danger : PnleTheme.accent;
