...
class AdMobIds {
  ...
  static const String androidInterstitial = 'ca-app-pub-9985022151393867/3280113188';
  static const String iosInterstitial = 'ca-app-pub-9985022151393867/7600399474';

  static const String androidRewarded = 'ca-app-pub-9985022151393867/2192486123';
  ...
  static String get banner {
    if (Platform.isAndroid) return useTestAds ? androidBannerTest : androidBanner;
  ...
  static String get interstitial {
    ...
    if (Platform.isIOS) return useTestAds ? iosInterstitialTest : iosInterstitial;
    throw UnsupportedError('Unsupported platform for AdMob interstitial');
  }

  static String get rewarded {
    if (Platform.isAndroid) return useTestAds ? androidRewardedTest : androidRewarded;
